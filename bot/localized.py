...
class Localized:
    """
   A class to manage localized keyboard buttons and messages for a bot interface.

   Attributes:
       self.buttons (dict): A dictionary containing button layouts for different languages.
        self.messages (dict): A dictionary containing messages for different languages.

   Methods:
       get_keyboard(keyboard_key: str, current_lang: str):
           Returns a keyboard object based on the current language setting.

       get_message(message_key: str, current_lang: str):
           Returns a message string based on the current language setting.
   """
